 ...
 */
package org.kroky.commons.logging;
...
public class JTextAreaAppender extends AbstractAppender {
    ...
    public void append(LogEvent event) {
        if (jTextArea == null) {
            LOGGER.warn(
                    "No JTextArea was set for the JTextAreaAppender. Please use the static setter JTextAreaAppender.setJTextArea()");
        ...
        SwingUtilities.invokeLater(() -> jTextArea.append(msg));
    }
}
